...
export default function Carousel() {
    return (
        <>
        <Box sx={{maxWidth: '500px', px: '3rem', pb: '2rem', minHeight: '600px', borderRadius: '10px', boxShadow: '0.5px 10px 12px 2px rgba(0, 0, 0, 0.3)', display: 'flex', alignItems: 'end', backgroundColor: 'primary.light'}}>
            <Swiper
                ...
                {carouselContent.map((content) => (
                    <SwiperSlide key={content.heading}>
                        <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '15px', textAlign: 'center'}}>
